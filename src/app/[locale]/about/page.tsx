  ...
  return (
    <main className="flex flex-col max-w-5xl mx-auto">
      ...
      <div>
        ...
        <SubTitle title={"Connect with me"} id="" />
        <form className="bg-gray-200 max-w-2xl flex flex-col justify-center items-center mx-auto">
          <Input className="rounded-none bg-transparent border border-goldenisher px-5 py-5" placeholder="Your email..." type="email"/>
          <Input className="rounded-none bg-transparent border border-goldenisher px-5 py-5" placeholder="A little message..." />
          <Button className="w-full rounded-none bg-[#35685C] hover:bg-[#274F45] border-goldenisher py-5">let&apos;s connect!</Button>
        </form>
      </div>
    </main>
  );
